...
PatientSchema.methods.getByProfile = function getByProfile(profile, isNegated = null) {
  ...
  return results.map(result => {
    var addFunctionsBack = false;
    var getCodeFunction = result.__proto__.getCode;
    var codeFunction = result.__proto__.code;
    var removedMongooseItems = AllDataElements[profile](result).toObject();
