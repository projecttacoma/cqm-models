...
RSpec.describe QDM::PatientGeneration do
  it 'single massive patient contains same number of dataElements that are in list of all patients' do
    ...
    stacked_patient = QDM::PatientGeneration.generate_exhastive_data_element_patients(false, 'qdm-modelinfo-5.5.xml')[0]
    stacked_patients = QDM::PatientGeneration.generate_exhastive_data_element_patients(true, 'qdm-modelinfo-5.5.xml')
