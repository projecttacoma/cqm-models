...
RSpec.describe QDM do
  ...
  def check_generator_datatypes_attributes(modelinfo_file, hqmf_oid_file)
    ...
    datatypes.each do |datatype, attributes|
      if datatype != 'Component' && datatype != 'FacilityLocation' && datatype != 'Entity' && datatype != 'ResultComponent' && datatype != 'DiagnosisComponent' && datatype != 'CarePartner' && datatype != 'Organization' && datatype != 'PatientEntity' && datatype != 'Practitioner'
